...
-- 执行逻辑
BEGIN
	INSERT ZQTreasureDBLink.ZQTreasureDB.dbo.RecordFlowerGrant(SendUserID,RcvUserID,KindID,ServerID,FlowerName,FlowerCount,FlowerPay,SendUserLoveliness,RcvUserLoveliness,GrantIP)
