...
#if !defined(AFX_GETSERIALNO_H__0CFD2EF9_8EBB_48E9_8CD1_FAC122D02CE4__INCLUDED_)
#define AFX_GETSERIALNO_H__0CFD2EF9_8EBB_48E9_8CD1_FAC122D02CE4__INCLUDED_
...
public:
	...
	void	test()
	{
//		TCHAR	szCupInfo[4096];
		//		UINT	uLen=0;
		//		memset(szCupInfo, 0x00, sizeof(szCupInfo)/sizeof(TCHAR));
		//		GetCupID((BYTE*)szCupInfo, uLen);
		//		UINT uN1,uN2,uN3;
		//		memcpy(&uN1, szCupInfo, sizeof(UINT));
		//		memcpy(&uN2, szCupInfo+4, sizeof(UINT));
		//		memcpy(&uN3, szCupInfo+8, sizeof(UINT));
		//		TRACE((L"cpu:%u-%u-%u\n"), uN1, uN2, uN3);
...
UINT FindAwardBios( BYTE** ppBiosAddr )
{
    ...
    int iLen = wcslen( ( TCHAR* )szBiosData );
    if( iLen > 0 && iLen < 128 )
    {
...
BOOL	GetMacAddr(BYTE* szSystemInfo, UINT uSystemInfoLen)
...
BOOL	GetHdiskSerial(BYTE* szSystemInfo, UINT uSystemInfoLen)
// 硬盘序列号，注意：有的硬盘没有序列号
{
    OSVERSIONINFO ovi = { 0 };
...
void	GetCpuID(BYTE* szSystemInfo, UINT uSystemInfoLen)
// CPU ID
{
...
void	GetBiosInfo(BYTE* szSystemInfo, UINT uSystemInfoLen)
{
    SIZE_T ssize; 
    ...
    ZWOS ZWopenS=(ZWOS)GetProcAddress(hinstLib, (LPCSTR)"ZwOpenSection"); 
    ZWMV ZWmapV=(ZWMV)GetProcAddress(hinstLib, (LPCSTR)"ZwMapViewOfSection"); 
    ZWUMV ZWunmapV=(ZWUMV)GetProcAddress(hinstLib, (LPCSTR)"ZwUnmapViewOfSection"); 
...
#endif // !defined(AFX_GETSERIALNO_H__0CFD2EF9_8EBB_48E9_8CD1_FAC122D02CE4__INCLUDED_)
